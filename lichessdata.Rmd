...
p1 = 1-pnorm(eps, player_data[game_data[n, 1], 1]-player_data[game_data[n, 2], 1], player_data[game_data[n, 1], 2]+player_data[game_data[n, 2], 2])
   #player 2 wins probability
p2 = 1-pnorm(eps, -player_data[game_data[n, 1], 1]+player_data[game_data[n, 2], 1], player_data[game_data[n, 1], 2]+player_data[game_data[n, 2], 2])
   #draw probability
p3 = max(1 - p1 - p2, 0)
...
```{r}
final_ratings_100 <- RateTrueskill(game_data, player_data, 100, 300)
```
